...
1. [Optional: Publishing the Artifact Manifest](#optional:-publishing-the-artifact-manifest) as a [Well Known Type][def-well-known-types]
...
1. Push the hello-world artifact with the `oras push` command:
    ...
    --manifest-config ./config.json:application/vnd.oci.samples.hello-world.config.v1+json \
...
|[Unknwon][artifacts-spec]|`application/vnd.oci.unknown.config.v1+json`|[vnd.oci.unknown.1](./artifactTypes/vnd.oci.unknown.1/)|
