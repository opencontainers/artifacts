...
type pullOpts struct {
	...
	contentProvideIngester artifactscontent.ProvideIngester
...
func WithContentProvideIngester(store artifactscontent.ProvideIngester) PullOpt {
	return func(o *pullOpts) error {
...
func pullStatusTrack(writer io.Writer) images.Handler {
	...
	return images.HandlerFunc(func(ctx context.Context, desc ocispec.Descriptor) ([]ocispec.Descriptor, error) {
		if name, ok := artifactscontent.ResolveName(desc); ok {
